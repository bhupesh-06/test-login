          ...
          <div className="signUpBox">
            ...
            <div className="confirmPassword">
              ...
              <img
                ...
                src={
                  isPasswordVisible
                    ? `https://d3lh160mhg6cwk.cloudfront.net/closed-eye.png`
                    : `https://d3lh160mhg6cwk.cloudfront.net/eye.png`
                }
            ...
            <div className="facebookButton">
              <img
                src={`https://d3lh160mhg6cwk.cloudfront.net/fb-circle.png`}
            ...
            <div className="googleButton">
              <img
                src={`https://d3lh160mhg6cwk.cloudfront.net/google.png`}
